...
def criar_aba_historico_entrada(notebook, global_state, ui_callbacks, ui_elements):
    ...
    frame_filtro_data = ttk.Frame(frame_filtros_master, style="Content.TFrame")
    ...
    frame_filtro_remetente = ttk.Frame(frame_filtros_master, style="Content.TFrame")
    ...
    frame_filtro_dest = ttk.Frame(frame_filtros_master, style="Content.TFrame")
    ...
    frame_botoes = ttk.Frame(frame_filtros_master, style="Content.TFrame")
...
def criar_aba_historico_saida(notebook, global_state, ui_callbacks, ui_elements):

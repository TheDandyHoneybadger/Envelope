...
def main():
    ...
    # Adiciona todas as configurações lidas ao estado global
    ...
    # 5. Configurar e construir a UI usando os módulos refatorados
    ...
    # 6. Definir estados iniciais dos widgets após a UI ser construída
...
if __name__ == "__main__":
    # Garante que o diretório do script esteja no path para importações corretas
